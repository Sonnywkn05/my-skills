# qa-engineer-skill-depth Specification

## Purpose
Define deeper QA-engineer skill guidance for risk-based design, test data strategy, backend/API coverage, performance testing tiers, and impact-based regression scope.
